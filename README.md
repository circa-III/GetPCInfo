...
-===[ UPDATE 26.03.04]===-
- Update script version to 26.03.04
- Refactor OneDrive registry access, replace the previous remote HKU path invocation with a registry-based lookup using Microsoft.Win32.Registry::Users and a try/catch
- Remove TenantName handling from output and simplify signed-in message.
